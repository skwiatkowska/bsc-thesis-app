...
<body class="login-body">
    <div class="login-page">
        <div class="form">
            <h2 class="mb-5"><strong>Błąd 404</strong></h2>
            <p>Podana strona nie istnieje</p>
            <div class="row">
                <div class="col-sm-3 mx-auto my-3">
                    <a type="button" class="btn btn-danger btn-rounded" style="color:white; background-color: #ef233c" onclick="window.history.back()">
                        Powrót
                    </a>
                </div>
            </div>
