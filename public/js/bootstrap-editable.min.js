...
!(function (a) {
            ...
            a.proxy(function (a) {
              ...
              var b =
                "function" == typeof this.options.success
                  ? this.options.success.call(this.options.scope, a, d)
                  : null;
              return b === !1
            ...
            a.proxy(function (a) {
              ...
              (b =
                "function" == typeof this.options.error
                  ? this.options.error.call(this.options.scope, a, d)
                  : "string" == typeof a
                  ? a
      ...
      (a.fn.editable = function (c) {
        ...
        switch (c) {
          ...
          case "submit":
            ...
            return (
              a.isEmptyObject(j)
                ? ((g = this.editable("getValue")),
                  h.data && a.extend(g, h.data),
                  a
                    .ajax(
                      a.extend(
                        { url: h.url, data: g, type: "POST" },
                        h.ajaxOptions
                      )
                    )
                    .success(function (a) {
                    ...
                    .error(function () {
                      "function" == typeof h.error &&
                        h.error.apply(i, arguments);
                    }))
                : "function" == typeof h.error && h.error.call(i, j),
              this
            );
        }
        return this.each(function () {
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
      a.extend(b.prototype, {
        ...
        str2value: function (b, c) {
          ...
          c =
            c ||
            this.options.select2.separator ||
            a.fn.select2.defaults.separator;
          var d, e, f;
    ...
    (b.prototype = {
      ...
      initCombos: function () {
        ...
        a.each(this.map, function (a) {
          ...
          e.length &&
            ((b["$" + a] = e),
            (c = "fill" + a.charAt(0).toUpperCase() + a.slice(1)),
            (d = b[c]()),
            b["$" + a].html(b.renderItems(d)));
        });
      },
  ...
  (function (a) {
    ...
    a.extend(a.fn.editableform.Constructor.prototype, {
      ...
      (a.fn.editableform.buttons =
        '<button type="submit" class="btn btn-primary btn-sm editable-submit"><i class="fa fa-check"></i></button><button type="button" class="btn btn-default btn-sm editable-cancel"><i class="fa fa-minus"></i></button>'),
      ...
      setPosition: function () {
        !function () {
          var a = this.tip(),
            ...
            d = a[0].offsetWidth,
            e = a[0].offsetHeight,
            f = this.getCalculatedOffset(b, c, d, e);
