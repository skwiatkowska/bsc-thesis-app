...
(function($) {
  ...
  defaults = {
    ...
    inputs: {
      ...
      paginationPrev: 'Poprzednie',
      paginationNext: 'Następne',
      ...
      perPageText: 'Pokaż: ',
      pageText: 'Strony: ',
      recordCountPageBoundTemplate: '{pageLowerBound} - {pageUpperBound} z',
      recordCountPageUnboundedTemplate: '{recordsShown} z',
      recordCountTotalTemplate: '{recordsQueryCount} {collectionName}',
      recordCountFilteredTemplate: ' (filtrowanie z {recordsTotal} wszystkich rekordów)',
      recordCountText: 'Wyświetlanie',
